...
public abstract class Slide {
    ...
    public Slide(Pane parentControls, Pane parentBody) {
        ...
        final ImageView backImage = new ImageView(
                new Image(Slide.class.getResourceAsStream("/images/back_button.png"), 25.0, 25.0, true, true));
    ...
    public void hide() {
        ...
        if (slideHiddenListener.isPresent())
            slideHiddenListener.get().onSlideHidden();
    }
