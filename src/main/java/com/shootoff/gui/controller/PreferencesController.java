...
public class PreferencesController
        implements DesignateShotRecorderListener, CameraSelectionListener, CameraRenamedListener {
    @FXML
    private ScrollPane preferencesPane;
    @FXML
    ...
    @FXML
    private ChoiceBox<String> calibratedOptionsChoiceBox;
    @FXML
    private CheckBox showArenaShotMarkersCheckBox;
    @FXML
    private CheckBox autoAdjustExposureCheckBox;
    ...
    public void setConfig(Stage parent, Configuration config, CalibrationConfigurator calibrationConfigurator,
        ...
        for (final Camera c : CameraFactory.getWebcams()) {
            if (!configuredCameras.contains(c))
