...
public class TargetCommands implements CommandProcessor {
    ...
    public void process(List<String> commands, String commandName, List<String> args) {
        ...
        case "poi_adjust":
            ...
            Pair<Double, Double> translated = canvasManager.translateCanvasToCameraPoint(
                    nodeBounds.getX() + reg.getBoundsInParent().getMinX() + regcenterx,
                    nodeBounds.getY() + reg.getBoundsInParent().getMinY() + regcentery);
