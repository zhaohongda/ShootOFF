...
public class TestSessionIO {
    ...
    public void testXMLSerialization() {
        ...
        if (!tempXMLSession.delete())
            System.err.println("Failed to delete " + tempXMLSession.getPath());
    }
    ...
    public void testJSONSerialization() {
        ...
        if (!tempJSONSession.delete())
            System.err.println("Failed to delete " + tempJSONSession.getPath());
    }
}
