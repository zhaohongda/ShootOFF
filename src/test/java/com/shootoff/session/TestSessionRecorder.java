...
public class TestSessionRecorder {
    ...
    public void setUp() throws ConfigurationException {
        ...
        target1 = new TargetView(new File(targetName1), new Group(), new HashMap<String, String>(), canvasManager,
                false);

        targetName2 = "shoot_dont_shoot" + File.separator + " shoot.target";
        target2 = new TargetView(new File(targetName2), new Group(), new HashMap<String, String>(), canvasManager,
                false);
