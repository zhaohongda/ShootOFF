...
public class TestPerspectiveManager {
    ...
    public void testOne() throws ConfigurationException {
        ...
        PerspectiveManager pm = new PerspectiveManager("C270", new Dimension2D(1280, 720),
                new BoundingBox(0, 0, 736, 544));
    ...
    public void testPaperPattern() throws IOException {
        ...
        Optional<Dimension2D> paperDimensions = acm.findPaperPattern(mat, patternList);
        ...
        pm = new PerspectiveManager(new BoundingBox(329, 35, 701, 545), new Dimension2D(1280, 720),
                paperDimensions.get(), new Dimension2D(1024, 768));
