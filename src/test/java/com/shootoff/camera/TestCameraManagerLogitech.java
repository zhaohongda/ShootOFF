...
public class TestCameraManagerLogitech extends ShotDetectionTestor {
    ...
    public void testLogitechIndoorGreen() {
        // Missing 2 shots
        List<DisplayShot> shots = findShots("/shotsearcher/logitech-indoor-green.mp4", Optional.empty(), mockManager,
    ...
    public void testLogitechOutdoorGreen2() {
        List<DisplayShot> shots = findShots("/shotsearcher/logitech-outdoor-green-2.mp4", Optional.empty(), mockManager,
                config, sectorStatuses);
    ...
    public void testLogitechSafariGreen() {
        List<DisplayShot> shots = findShots("/shotsearcher/logitech-safari-green.mp4", Optional.empty(), mockManager,
                config, sectorStatuses);
    ...
    public void testLogitechOutdoorRed() {
        List<DisplayShot> shots = findShots("/shotsearcher/logitech-outdoor-red.mp4", Optional.empty(), mockManager,
                config, sectorStatuses);
    ...
    public void testLogitechSafariRed() {
        List<DisplayShot> shots = findShots("/shotsearcher/logitech-safari-red.mp4", Optional.empty(), mockManager,
                config, sectorStatuses);
    ...
    public void testLogitechBouncingTargetsNoBG() {
        ...
        List<DisplayShot> shots = findShots("/shotsearcher/logitech-nobg-bouncingtargets-noshots.mp4", Optional.empty(),
    ...
    public void testLogitechBouncingTargetsOutdoor() {
        ...
        List<DisplayShot> shots = findShots("/shotsearcher/logitech-outdoor-bouncingtargets-noshots.mp4",
