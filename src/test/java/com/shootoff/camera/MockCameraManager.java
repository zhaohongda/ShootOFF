...
public class MockCameraManager extends CameraManager implements CameraEventListener {
    ...
    protected MockCameraManager(MockCamera camera, CanvasManager canvas, boolean[][] sectorStatuses,
            Optional<Bounds> projectionBounds, VideoFinishedListener videoFinishedListener) {
