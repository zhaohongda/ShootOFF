...
public class TestCameraManagerLifecam extends ShotDetectionTestor {
    ...
    public void testLifecamIndoorGreen() {
        List<DisplayShot> shots = findShots("/shotsearcher/lifecam-indoor-green.mp4", Optional.empty(), mockManager,
    ...
    public void testLifecamOutdoorGreen() {
        List<DisplayShot> shots = findShots("/shotsearcher/lifecam-outdoor-green.mp4", Optional.empty(), mockManager,
                config, sectorStatuses);
    ...
    public void testLifecamSafariGreen() {
        List<DisplayShot> shots = findShots("/shotsearcher/lifecam-safari-green.mp4", Optional.empty(), mockManager,
                config, sectorStatuses);
    ...
    public void testLifecamMotion() {
        List<DisplayShot> shots = findShots("/shotsearcher/lifecam-motion-in-room.mp4", Optional.empty(), mockManager,
                config, sectorStatuses);
    ...
    public void testLifecamDuelTree() {
        List<DisplayShot> shots = findShots("/shotsearcher/lifecam-indoor-tree-green.mp4", Optional.empty(),
