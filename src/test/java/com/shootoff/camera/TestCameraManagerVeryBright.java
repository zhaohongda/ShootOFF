...
public class TestCameraManagerVeryBright extends ShotDetectionTestor {
    ...
    public void testMSHD3000MinBrightnessDefaultContrastWhiteBalanceOff() {
        ...
        List<DisplayShot> shots = findShots(
                "/shotsearcher/mshd3000_min_brightness_default_contrast_whitebalance_off.mp4", Optional.empty(),
    ...
    public void testMSHD3000MinBrightnessDefaultContrastWhiteBalanceOn() {
        ...
        List<DisplayShot> shots = findShots(
                "/shotsearcher/mshd3000_min_brightness_default_contrast_whitebalance_on.mp4", Optional.empty(),
                mockManager, config, sectorStatuses);
