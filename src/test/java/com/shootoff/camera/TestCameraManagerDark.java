...
public class TestCameraManagerDark extends ShotDetectionTestor {
    ...
    public void testNoInterferenceTwoShots() {
        List<DisplayShot> shots = findShots("/shotsearcher/no_interference_two_shots.mp4", Optional.empty(),
    ...
    public void testPS3EyeHardwareDefaultsDarkRoom() {
        List<DisplayShot> shots = findShots("/shotsearcher/ps3eye_hardware_defaults_projector_dark_room.mp4",
